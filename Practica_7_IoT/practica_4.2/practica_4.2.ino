...
* Define Constants
****************************************/
#define WIFISSID "INFINITUMAFAF_EXT1" //WIFI SSID aqui
#define PASSWORD "Dbq3x7eXCj" // WIFI pwd
#define TOKEN "BBUS-YQwxpawoYyNkdTdxhRKsJ3npeNUewB" // Ubidots TOKEN ID el mismo que usamos en clase lo sacan de Ubidtos
...
#define VARIABLE_LABEL_hum "humidity" // Variable Humedad
#define DEVICE_LABEL "practicona4" // Nombre del dispositivo a crear
